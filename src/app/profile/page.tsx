            ...
            <section className="mt-16">
                <div className="text-center">
                    ...
                    <p className="mx-auto mt-2 max-w-2xl text-muted-foreground">
                        Pelajari lebih lanjut tentang apa yang membuat sekolah
                        kami istimewa.
                    </p>
                </div>
                <div className="mt-12 grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-4">
                    <Link href="/profile/vision-mission">
                        <Card className="h-full transform text-center transition-all duration-300 hover:-translate-y-2 hover:shadow-2xl">
                            <CardHeader className="items-center">
                                ...
                                <CardTitle className="font-headline pt-4 text-primary">
                                    Visi & Misi
                                </CardTitle>
                            </CardHeader>
                            <CardContent>
                                <p className="text-muted-foreground">
                                    Prinsip-prinsip penuntun yang membentuk
                                    setiap aspek kehidupan di SMPN 24 Padang.
                                </p>
                            </CardContent>
                        </Card>
                    </Link>
                    <Link href="/profile/faculty">
                        <Card className="h-full transform text-center transition-all duration-300 hover:-translate-y-2 hover:shadow-2xl">
                            ...
                            <CardContent>
                                <p className="text-muted-foreground">
                                    Temui para pendidik berpengalaman yang
                                    membimbing siswa kami.
                                </p>
                            </CardContent>
                        </Card>
                    </Link>
                    <Link href="/profile/organization-structure">
                        <Card className="h-full transform text-center transition-all duration-300 hover:-translate-y-2 hover:shadow-2xl">
                            ...
                            <CardContent>
                                <p className="text-muted-foreground">
                                    Lihat bagaimana sekolah kami terstruktur
                    ...
                    <Link href="/profile/accreditation">
                        <Card className="h-full transform text-center transition-all duration-300 hover:-translate-y-2 hover:shadow-2xl">
                            ...
                            <CardContent>
                                <p className="text-muted-foreground">
                                    Lihat pengakuan dan sertifikasi resmi
                                    sekolah kami.
                                </p>
                            </CardContent>
                        </Card>
                    ...
                    <Link href="/profile/uniform">
                        <Card className="h-full transform text-center transition-all duration-300 hover:-translate-y-2 hover:shadow-2xl">
                            ...
                            <CardContent>
                                <p className="text-muted-foreground">
                                    Panduan seragam resmi untuk siswa-siswi
                                    kami.
                                </p>
                            </CardContent>
                        </Card>
                    ...
                    <Link href="/profile/extracurricular">
                        <Card className="h-full transform text-center transition-all duration-300 hover:-translate-y-2 hover:shadow-2xl">
                            ...
                            <CardContent>
                                <p className="text-muted-foreground">
                                    Temukan minat dan kembangkan bakat melalui
                                    kegiatan kami.
                                </p>
                            </CardContent>
                        </Card>
