...
export default async function AcademicsPage() {
        ...
        return (
            <div className="container mx-auto px-4 py-12 md:py-24 text-center">
                ...
                <p className="mx-auto mt-4 max-w-2xl text-lg text-muted-foreground">
                    Konten akademik belum tersedia. Silakan periksa kembali
                    nanti.
                </p>
            </div>
        );
    ...
    const curriculumParagraphs = academics.curriculumDescription
        .split('\n')
        .filter((p) => p.trim() !== '');
    const structureParagraphs = academics.structureDescription
        .split('\n')
        .filter((p) => p.trim() !== '');
    ...
    return (
        <div className="container mx-auto px-4 py-12 md:py-24">
            <div className="text-center">
                ...
                <p className="mx-auto mt-4 max-w-2xl text-lg text-muted-foreground">
                    Menumbuhkan Keunggulan Intelektual dan Semangat Belajar
                    Seumur Hidup.
                </p>
            </div>
            ...
            <Tabs defaultValue="curriculum" className="mt-12 w-full">
                <TabsList className="grid w-full grid-cols-1 md:grid-cols-2">
                    ...
                    <TabsTrigger value="organization">
                        <Building className="mr-2 h-5 w-5" /> Struktur
                        Pembelajaran
                    </TabsTrigger>
                </TabsList>
