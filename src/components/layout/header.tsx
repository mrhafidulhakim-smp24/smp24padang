                                                                ...
                                                                {link.subLinks.map(
                                                                    (
                                                                        ...
                                                                        <Link
                                                                            ...
                                                                            className={cn(
                                                                                'flex items-center gap-3 rounded-md p-3 text-lg font-semibold text-foreground hover:bg-accent hover:text-accent-foreground border-b border-gray-200 last:border-b-0',
                                                                                cleanPathname ===
                                                                                    subLink.href &&
                                                                                    '',
                                                                            )}
