...
ALTER TABLE "setoran_guru" ADD CONSTRAINT "setoran_guru_guru_id_guru_sispendik_id_fk" FOREIGN KEY ("guru_id") REFERENCES "public"."guru_sispendik"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "setoran_guru" ADD CONSTRAINT "setoran_guru_jenis_sampah_id_jenis_sampah_id_fk" FOREIGN KEY ("jenis_sampah_id") REFERENCES "public"."jenis_sampah"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
